...
from redbox.models import Chunk, Tag, Feedback, File, SpotlightComplete
...
class BaseStorageHandler(ABC):
    ...
    model_type_map = {v.__name__.lower(): v for v in [Chunk, Tag, Feedback, File, SpotlightComplete]}
